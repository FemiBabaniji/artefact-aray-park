...
import { DrillTile, IdentityEditor, RoomView, RoomFullscreen, OnboardingCard } from "./typed";
...
export function ExpandedRenderer({
  accent,
  colorId,
  onColorChange,
  onCollapse,
                ...
                >
                  {readOnly ? (
                    ...
                    <OnboardingCard
                      ...
                      description="Add your identity details and start building rooms to showcase your work."
                      buttonLabel="Get Started"
                      onAction={() => setView("identity")}
                      accent={accent}
                    />
                  )}
                </motion.div>
